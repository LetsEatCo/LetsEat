...
export const CART_ADD_PRODUCT = '@@cart/CART_ADD_PRODUCT';
export const CART_ADD_PRODUCT_SUCCEEDED = '@@cart/CART_ADD_PRODUCT_SUCCEEDED';
export const CART_ADD_PRODUCT_FAILED = '@@cart/CART_ADD_PRODUCT_FAILED';
